...
"FOR PURPOSES OF (THE FICA), THE TERM 'EMPLOYEE' MEANS-- (1) ANY OFFICER OF A CORPORATION; OR (2) ANY INDIVIDUAL WHO, UNDER THE USUAL COMMON LAW RULES APPLICABLE IN DETERMINING THE EMPLOYER-EMPLOYEE RELATIONSHIP, HAS THE STATUS OF AN EMPLOYEE; OR (3) (ANY MEMBER OF SEVERAL SPECIFIC OCCUPATIONS, NOT INCLUDING FISHING, WHEN CERTAIN CONDITIONS ARE SATISFIED)."  26 U.S.C. 3121(D).
...
/6/  SOCIAL SECURITY ACT SEC. 1101(A)(6), 49 STAT. 647.  THE LANGUAGE OF SEC. 1101(A)(6) WAS CARRIED OVER TO SECS. 1426(C) AND 1607(H) OF THE INTERNAL REVENUE CODE OF 1939, THE PREDECESSORS OF PRESENT SECS. 3121(D) AND 3306(I) OF TITLE 26, RESPECTIVELY.  SEE 53 STAT. 178, 188.
